 ...
 * BY EARL T {ET}
 *
 * THIS IS THE NOVELTY CALCULATOR IVE MADE TO HAVE A X86_64 BASED TEST/DEMO
...
int main(void) {
  printf("CORDIC CALLCATOR NOVILTY CALCULATOR \n USES CORDIC APROXAMATIONS FOR "
         "FUNCTIONS:\n KINDA JUST PLAYING AROUND WITH THE LIB OF CORDIC "
